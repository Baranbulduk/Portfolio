      ...
      <div className="wrapper">
          <section className="info_container">
            <div className="location_container">
              ...
              <img className="location_image_light" src={LocationLight} alt="Location" />
            ...
            <div className="telNr_container">
              <img className="telNr_image" src={TelNrDark} alt="Telephone Number" />
              <img className="telNr_image_light" src={TelNrLight} alt="Telephone Number" />
              <span>+46 725533234</span>
            </div>
          </section>
          <div className="apps_container">
            <Link to="#"><img className="github_image" src={GithubDark} alt="Github" /></Link>
            <Link to="#"><img className="github_image_light" src={GithubLight} alt="Github" /></Link>
            <Link to="#"><img className="linkedIn_image" src={LinkedinDark} alt="Linkedin" /></Link>
            <Link to="#"><img className="linkedIn_image_light" src={LinkedinLight} alt="Linkedin" /></Link>
          </div>
